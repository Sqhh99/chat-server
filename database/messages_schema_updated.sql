...
(
    ...
    from_user_id integer                                                       not null
        constraint fk_private_messages_from_user
            references users
            on delete cascade,
    to_user_id   integer                                                       not null
        constraint fk_private_messages_to_user
            references users
            on delete cascade,
...
(
    ...
    group_id     integer                                                     not null
        constraint fk_group_messages_group
            ...
            on delete cascade,
    from_user_id integer                                                     not null
        constraint fk_group_messages_from_user
            references users
            on delete cascade,
    content      text                                                        not null,
    timestamp    timestamp with time zone default CURRENT_TIMESTAMP          not null,
...
(
    ...
    user_id1   integer                                                        not null
        constraint fk_user_friends_user1
            references users
            on delete cascade,
    user_id2   integer                                                        not null
        constraint fk_user_friends_user2
            references users
            on delete cascade,
